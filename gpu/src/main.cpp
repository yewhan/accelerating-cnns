...
It is designed for use with a GTX 1080 Ti.
2 different GPU kernels are specified within kernel.cu, and are called from optimised_layer_FP
*/
...
int main() {
    ...
    optimised_layer_FP(in_FP, filter_FP, bias_array_FP, out_FP);
...
void read_layer_dimensions() {
    ...
    //std::cout << std::format("Input_Output_batch_dim = {}\nOutput_depth_dim = {}\nOutput_Y_dim = {}", Input_Output_batch_dim, Output_depth_dim, Output_Y_dim);
