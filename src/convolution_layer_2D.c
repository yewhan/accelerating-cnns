...
// ~72/73 GFLOPS, same perf as before. maybe optimised out by -O3? asm shows shl isn't added by compiler automatically
...
// reduce int register pressure in d and x loop (also reduces num of ops done) - optimised_layer_v5_x2m4_loop_interchange_m_FP()
// ~ 73/74 GFLOPS
...
// reduce int register pressure in d and x loop (also reduces num of ops done) - optimised_layer_v5_x3m3_loop_interchange_m_FP()
// ~76 GFLOPS, maybe increased code size is causing it? 
